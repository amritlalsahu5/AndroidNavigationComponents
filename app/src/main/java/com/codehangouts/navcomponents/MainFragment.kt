...
class MainFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.btn_view_history).setOnClickListener(this)
    ...
    override fun onClick(v: View?) {
        when(v!!.id){
            ...
            R.id.btn_view_history -> navController!!.navigate(R.id.action_mainFragment_to_viewTransactionFragment)
